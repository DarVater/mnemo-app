...
source_by_top = {
    'Город': 'premium-icon-house-5175974',
    'Дом': 'premium-icon-house-5175974',
    'Еда': 'premium-icon-house-5175974',
    'Природа': 'premium-icon-house-5175974',
    'Человек': 'premium-icon-house-5175974',
    'Отношения': 'premium-icon-house-5175974',
    'Транспорт': 'premium-icon-house-5175974',
    'Животные': 'premium-icon-house-5175974',
    'Спорт': 'premium-icon-house-5175974',
    'Цвета': 'premium-icon-house-5175974',
    'Работа': 'premium-icon-house-5175974',
    'Профессии': 'premium-icon-house-5175974',
    'Изучение': 'premium-icon-house-5175974',
    'Развлечения': 'premium-icon-house-5175974',
    'Время': 'premium-icon-house-5175974',
    'Календарь': 'premium-icon-house-5175974',
    'Одежда': 'premium-icon-house-5175974',
    'Хобби': 'premium-icon-house-5175974',
    'Другое': 'premium-icon-house-5175974',
    'Указатели': 'premium-icon-house-5175974',
    'Восклицание': 'premium-icon-house-5175974',
    'союзы': 'premium-icon-house-5175974',
    'числа': 'premium-icon-house-5175974',
    'Предлог': 'premium-icon-house-5175974',
    'Наречие': 'premium-icon-house-5175974',
    'Глаголы наличия': 'premium-icon-house-5175974',
    'Глаголы операции': 'premium-icon-house-5175974',
    'Глаголы общения': 'premium-icon-house-5175974',
    'Глаголы  стадии': 'premium-icon-house-5175974',
    'Глаголы восприятия и мышления': 'premium-icon-house-5175974',
    'Глаголы движения': 'premium-icon-house-5175974',
    'Глаголы восприятия': 'premium-icon-house-5175974',
    'Другие глаголы': 'premium-icon-house-5175974',
    'Эмоции': 'premium-icon-house-5175974',
    'Абстрактные': 'premium-icon-house-5175974',
    'На глаз': 'premium-icon-house-5175974',
    'Состояние': 'premium-icon-house-5175974',
    'Качества': 'premium-icon-house-5175974',
    'Местоимения': 'premium-icon-house-5175974',
}
...
words_by_lvl = {'ru': {
    ...
    'Природа': {'air': 'воздух', 'cold': 'холод', 'rain': 'дождь', 'shower': 'ливень', 'snow': 'снег',
                ...
                'space': 'пространство', 'star': 'звезда;светило', 'sun': 'Солнце', 'flower': 'цветок',
    ...
    'Глаголы наличия': {'add': 'добавлять', 'have': 'иметь', 'include': 'включать',
    ...
    'Глаголы операции': {'break': 'ломать/ломаться', 'change': 'изменять',
    ...
    'Глаголы общения': {'agree': 'соглашаться', 'answer': 'отвечать', 'ask': 'спрашивать',
    ...
    'Глаголы  стадии': {'arrive': 'появиться/подвернуться', 'become': 'наступать, приближаться',
                        ...
                        'turn': 'становиться'},
    'Глаголы движения': {'arrive': 'прибывать', 'come': 'приходить', 'drive': 'двигать/гнать/ехать',
    ...
    'Глаголы восприятия и мышления': {'believe': 'считать/думать', 'call': 'звать, называть', 'check': 'проверять',
    ...
    'Местоимения': {'as': 'что', 'all': 'все', 'another': 'еще один', 'any': 'любой', 'anyone': 'кто-нибудь (один)',
                 ...
                 'it': 'это', 'some': 'некоторые', 'somebody': 'кто-то (может быть знаком)', 'that': 'тот', 'us': 'нас',
